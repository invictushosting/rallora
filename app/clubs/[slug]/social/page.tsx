...
type Ready = { kind: "ready"; club: Club; role: string; matches: Match[] };
...
export default function ClubSocialStudio() {
  ...
  async function downloadGraphic() {
    ...
    try {
      ...
      ctx.fillStyle = "#061A39"; ctx.fillRect(0, 0, 1080, 1080);
      ...
      const room = Math.max(1, Math.floor((825 - start) / 52));
      ...
      ctx.textAlign = "right"; ctx.fillText("YOUR CLUB. YOUR GAME.", 1005, 975);
      const href = canvas.toDataURL("image/png");
      const link = document.createElement("a");
      link.href = href; link.download = `rallora-${ready.club.slug}-social.png`;
  ...
  return <main className={styles.page}><div className={styles.shell}>
    ...
    <div className={styles.grid}>
      <section className={styles.editor} aria-labelledby="compose-title">
        ...
        <p className={styles.disclaimer}>These are manual sharing destinations.
